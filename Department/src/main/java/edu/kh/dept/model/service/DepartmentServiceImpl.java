...
public class DepartmentServiceImpl implements DepartmentService{
	...
	// 모든 부서 조회
	@Override
	public List<Department> selectAll() throws DepartmentInsertException {
	...
	public int insertDepartment(Department dept) throws DepartmentInsertException {
		...
		catch (SQLException e) 
		{
			...
			// 예외 발생 시 무조건 rollback 시키기
			rollback(conn);
			
			/* 제약 조건 위배로 인해 정상 수행되지 않음을 표현하기 위해 강제로 예외 발생시킴 */
			
			throw new DepartmentInsertException();
			
			
		} finally { // 예외 발생 여부 관계없이 무조건 실행. 커넥션 close
